...
namespace Cell
{
    ...
    */
    ...
    public:
        ...
        static SceneNode*  LoadMesh(Renderer* renderer, std::string name, std::string path,bool bSetDefaultMaterial=true);

		static bool			LoadAnimationClip(SceneNode* node,std::string path);

		static bool			LoadMaterialFromJson(Renderer* renderer, SceneNode* node, std::string path);
