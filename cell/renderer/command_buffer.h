...
namespace Cell
{
    ...
    */
    ...
    public:
        ...
        void Push(Mesh* mesh, Material* material, math::mat4f transform = math::mat4f(), math::mat4f prevTransform = math::mat4f(), math::vec3f boxMin = math::vec3f(-99999.0f), math::vec3f boxMax = math::vec3f(99999.0f), RenderTarget* target = nullptr);

		// pushes render state relevant to a single render call to the command buffer.
		void Push(SceneNode * node, RenderTarget * target=nullptr);
