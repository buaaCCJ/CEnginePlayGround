...
namespace Cell
{
    ...
    */
    ...
    public:
        ...
        void AddIrradianceProbe(PBRCapture* capture, math::vec3f position, float radius);
        ...
        std::vector<PBRCapture*> GetIrradianceProbes(math::vec3f queryPos, float queryRadius);
